...
class ButterflyClassifierMapper(object):
    ...
    def __call__(self, img_dict):
        ...
        img_name = img_dict["img"].split("/")[-2:]
        img_name = img_name[-2] + "_" + img_name[-1].split('.jpg')[0]
        result_dict["img_name"] = img_name
