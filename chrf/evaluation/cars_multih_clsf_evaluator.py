...
class CarsMultihClsfEvaluator(DatasetEvaluator):
    def __init__(self, dataset_name, distributed, output_dir=None) -> None:
        ...
        #There are 2 hierarchies including model, maker
        self.gt_model = []
        self.gt_maker = []
    ...
    def process(self, inputs, outputs):
        ...
        """
        score_model, acc_model, score_maker, acc_maker = outputs
    ...
    def evaluate(self):
        ...
        result["classification"] = pd.DataFrame(
            data=np.array([[model_top1_acc, model_top5_acc, maker_top1_acc, maker_top5_acc]]),
            columns=["model-top-1", "model-top-5", "maker-top-1", "maker-top-5"],
        )
