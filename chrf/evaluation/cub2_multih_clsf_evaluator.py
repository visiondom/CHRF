...
class CUB2MultihClsfEvaluator(DatasetEvaluator):
    def __init__(self, dataset_name, distributed, output_dir=None) -> None:
        ...
        #There are 3 hierarchies including class, family and order
        self.gt_class = []
        self.gt_family = []
        self.gt_order = []
    ...
    def process(self, inputs, outputs):
        ...
        """
        score_class, acc_class, score_family, acc_family, score_order, acc_order = outputs
    ...
    def evaluate(self):
        ...
        result["classification"] = pd.DataFrame(
            data=np.array([[class_top1_acc, class_top5_acc,
                            family_top1_acc, family_top5_acc, order_top1_acc, order_top5_acc,]]),
            columns=["class-top-1", "class-top-5",
